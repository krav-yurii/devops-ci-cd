...
aws eks update-kubeconfig --region eu-north-1 --name krav-yurii-lesson-8-9-eks
...
aws ecr list-images --repository-name krav-yurii-lesson-8-9-ecr --region eu-north-1
